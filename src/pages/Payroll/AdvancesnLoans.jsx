// pages/Payroll/AdvancesnLoans.jsx
...
export default function AdvancesnLoans() {
  ...
  function handleSearch(e) {
    ...
    console.log("Search advances & loans", { month, year, billable });
  }
  ...
  return (
    <>
      <PageMeta
        title="Advances & Loans | HRMS"
        description="Manage advances and loans vouchers"
      />
      ...
      <div className="space-y-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="text-xs text-slate-400">
            ...
            <span className="mx-1">›</span> Advances &amp; Loans
          </nav>
        </div>
          ...
          >
            ...
            <div className="flex flex-col md:items-end">
              ...
              <select
                ...
                className="rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 focus:border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-100 min-w-[140px]"
              >
